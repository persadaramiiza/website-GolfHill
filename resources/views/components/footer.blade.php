<footer class="pt-16 pb-0" style="background: linear-gradient(135deg, #FFF 0%, #F1F2F3 100%);">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
                ...
                <div class="space-y-6">
                    <div class="flex items-center gap-4">
                        ...
                        <a href="https://wa.me/6281803730325" target="_blank" rel="noopener noreferrer" class="text-lg sm:text-xl font-bold text-black hover:opacity-80 transition break-all sm:break-normal">
                            0818-0373-0325
                        </a>
                    </div>
                    <div class="flex items-center gap-4">
        ...
        <div class="text-center mt-8 mb-12">
            ...
            <a href="{{ route('articles.index') }}" class="text-base sm:text-lg font-bold hover:opacity-80 transition" style="color: #00377D;">
                Visit Our Article
            </a>
        </div>
