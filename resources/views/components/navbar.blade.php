    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10">
        <div class="flex justify-between h-20 items-center">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-4">
                <img src="{{ asset('images/logo.png') }}" alt="GolfHill Terraces logo" class="h-12 sm:h-14 w-auto">
                <img src="{{ asset('images/brand.png') }}" alt="GolfHill Terraces" class="h-8 sm:h-10 lg:h-11 w-auto">
            </a>
